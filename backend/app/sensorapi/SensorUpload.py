...
async def list_sensor_uploads(
    ...
    sensor_type: Annotated[Optional[List[str]], Query(title="传感器类型", description="按传感器类型查询，支持多个")] = None,
