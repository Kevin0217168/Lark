  ...
  <div class="cloud-register-page">
    ...
    <div class="register-container">
      ...
      <div class="logo-section">
        ...
        <p class="app-subtitle">创建账号，开始您的云养之旅</p>
      </div>
      ...
      <div class="register-card">
        ...
        <form class="register-form" @submit.prevent="handleRegister">
          ...
          <div class="form-group">
            <div class="input-field" :class="{ 'error': errors.nickname }">
              <div class="input-icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="form-group">
            <div class="input-field" :class="{ 'error': errors.invitationCode }">
              <div class="input-icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div v-if="errors.invitationCode" class="error-message">{{ errors.invitationCode }}</div>
          </div>
          
          <div class="form-group">
            <div class="input-field" :class="{ 'error': errors.avatar }">
              <div class="input-icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="register-footer">
          <router-link to="/cloud/login" class="login-link">已有账号？去登录</router-link>
        </div>
...
const validateNickname = (): string => {
  ...
  if (form.nickname.length < 1 || form.nickname.length > 50) {
    return '昵称长度在 1 到 50 个字符';
  }
  return '';
};

const validateInvitationCode = (): string => {
  if (!form.invitationCode) {
    return '请输入邀请码';
  }
  if (form.invitationCode.length < 9 || form.invitationCode.length > 11) {
    return '邀请码长度必须为9-11个字符';
  }
  return '';
};
...
const validateField = (field: keyof typeof form) => {
  switch (field) {
    ...
    case 'nickname':
      ...
      break;
    case 'invitationCode':
      errors.invitationCode = validateInvitationCode();
      break;
    case 'avatar':
      errors.avatar = validateAvatar();
      break;
  }
};
